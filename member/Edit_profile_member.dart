...
import 'package:gym_management/Firebase%20Multi%20Login_Gym/member/Member_home_page.dart';
...
class Edit_Profile_Member extends StatefulWidget {

  final  name,image,id,phone,address,gender,age;
  const Edit_Profile_Member({Key? key,
...
class _Edit_Profile_TrainerState extends State<Edit_Profile_Member> {
